(function (y, v) {
    ...
    var C = (y, v, N) =>
        new Promise((R, O) => {
            var X = P => {
                ...
                q = P =>
                    P.done ? R(P.value) : Promise.resolve(P.value).then(X, j);
    ...
    function J(e) {
        var t;
        return (t = e && I(e) ? (e == null ? void 0 : e.ownerDocument) : e) !=
            null
            ? t
            : window.document;
    }
    ...
    function dt(e) {
        ...
        const [t, r] = e.split(","),
            n =
                (c = (o = t.match(/data:(.+);/)) == null ? void 0 : o[1]) !=
                null
                    ? c
                    : void 0,
            i = window.atob(r),
            ...
            const { scale: r = 1, workerUrl: n, workerNumber: i = 1 } = t || {},
                ...
                l = M(
                    ...
                    ),
                    {
                        ...
                        svgDefsElement:
                            o == null ? void 0 : o.createElementNS(K, "defs"),
                        svgStyles: new Map(),
                        defaultComputedStyles: new Map(),
                        workers: [
                            ...Array.from({ length: ze && n && i ? i : 0 })
                        ]
                            .map(() => {
                                try {
...
`);
        ...
        return C(this, null, function* () {
            ...
            if ((u(), t.isEnable("fixSvgXmlDecode")))
                for (let l = 0; l < i; l++)
                    yield new Promise(d => {
                        setTimeout(() => {
                            (c == null || c.clearRect(0, 0, o.width, o.height),
                                u(),
                                d());
                        }, l + a);
                    });
    ...
    function Rt(e, t, r, n) {
        ...
        (l.delete("transition-property"),
            ...
            ((d = l.get("background-clip")) == null ? void 0 : d[0]) ===
                "text" && t.classList.add("______background-clip--text"),
            le &&
                (l.has("font-kerning") || l.set("font-kerning", ["normal", ""]),
                (((m = l.get("overflow-x")) == null ? void 0 : m[0]) ===
                    "hidden" ||
                    ((f = l.get("overflow-y")) == null ? void 0 : f[0]) ===
                        "hidden") &&
    ...
    function Pt(e, t, r, n, i) {
        ...
        function u(l) {
            ...
            (g.delete("content"),
                ...
                ((w = g.get("background-clip")) == null ? void 0 : w[0]) ===
                    "text" && t.classList.add("______background-clip--text"));
            const p = [`content: '${m}';`];
            if (
                (g.forEach(([S, T], A) => {
                ...
                return !n || n === "none"
                    ...
                    : ((G || te) && t.drawImageCount++,
                      Re(n, null, t, !0).then(i => {
                          !i ||
                              n === i ||
                              e.setProperty(r, i, e.getPropertyPriority(r));
                      }));
            })
            .filter(Boolean);
    }
